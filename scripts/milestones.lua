...
remote.add_interface("PyBlock", {
    milestones_presets = function()
        local preset = {
            required_mods = {"pyindustry", "pycoalprocessing", "pyfusionenergy", "pyrawores", "pypetroleumhandling", "pyhightech", "pyalienlife", "pyalternativeenergy", "pypostprocessing", "PyBlock"},
            milestones = {
                ...
                {type = "item",       name = "seaweed-mk02",                  quantity = 1,    hidden = true},
                {type = "item",       name = "seaweed-mk03",                  quantity = 1,    hidden = true},
                {type = "item",       name = "seaweed-mk04",                  quantity = 1,    hidden = true},
                {type = "item",       name = "fish-mk02",                     quantity = 1,    hidden = true},
                {type = "item",       name = "fish-mk03",                     quantity = 1,    hidden = true},
                {type = "item",       name = "fish-mk04",                     quantity = 1,    hidden = true},
                ...
                {type = "item",       name = "uranyl-nitrate",                quantity = 1,    hidden = true},
                ...
                -- enriched biomass
                {type = "item",       name = "fe-biomass",                    quantity = 1,    hidden = true},
                {type = "item",       name = "cu-biomass",                    quantity = 1,    hidden = true},
                {type = "item",       name = "al-biomass",                    quantity = 1,    hidden = true},
                {type = "item",       name = "sn-biomass",                    quantity = 1,    hidden = true},
                {type = "item",       name = "zn-biomass",                    quantity = 1,    hidden = true},
                {type = "item",       name = "pb-biomass",                    quantity = 1,    hidden = true},
                {type = "item",       name = "ti-biomass",                    quantity = 1,    hidden = true},
                {type = "item",       name = "ni-biomass",                    quantity = 1,    hidden = true},
                {type = "item",       name = "nb-biomass",                    quantity = 1,    hidden = true},
                {type = "item",       name = "nacl-biomass",                  quantity = 1,    hidden = true},
                {type = "item",       name = "s-biomass",                     quantity = 1,    hidden = true},
                {type = "item",       name = "ur-biomass",                    quantity = 1,    hidden = true},
                {type = "item",       name = "ag-biomass",                    quantity = 1,    hidden = true},
                {type = "item",       name = "au-biomass",                    quantity = 1,    hidden = true},
                {type = "item",       name = "co-biomass",                    quantity = 1,    hidden = true},
